...
export const insights: Insight[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'Family offices are central to making that stack work. The catalytic, patient, risk-absorbing seats, first-loss capital, guarantees, blended structures, credit for measurable outcomes, are exactly the ones an institutional fund usually cannot fill.',
    ],
  },
  {
    id: 'insight-4',
