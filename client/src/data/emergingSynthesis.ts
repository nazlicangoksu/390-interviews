...
export const insights: Insight[] = [
  {
    ...
    body: [
      "Nobody's first climate investment comes from a spreadsheet. It comes from a grandchild's question at dinner, or from watching a coral reef die and writing a check. FOMO, legacy, identity, personal experience. These are the on-ramps. The financial case comes later, as justification.",
  ...
  },
  {
    ...
    body: [
      ...
      'The companies still raising are the ones that never needed the word in the first place. They pitch as advanced manufacturing, chemistry, materials, infrastructure. The climate impact is real but it is the consequence of the business working, not the reason to invest. The better frame is collinearity: impact equals business revenue. More carbon removed, more clean energy deployed, more waste diverted. These are not philanthropic byproducts. They are the top line.',
    ],
  },
  {
    id: 'insight-4',
    ...
    section: 'why-not-enter',
    body: [
      'Ocean investing alone is an entire career specialty. Carbon removal, grid infrastructure, industrial decarbonization, sustainable agriculture, biodiversity, building efficiency. Each has its own science, its own market dynamics, its own regulatory landscape. No single family office can build fluency across all of it. And they know it.',
  ...
  },
  {
    ...
    section: 'what-keeps-scaling',
    body: [
      'The conversation around climate capital is almost entirely framed as investment: here is a fund, here is a return, here is an impact thesis. But wealthy families already have climate exposure they have not been shown. Coastal real estate, supply chain dependencies, agricultural holdings, infrastructure assets. The risk is already in their portfolio. Nobody put it there as a climate bet. It arrived as weather, as insurance withdrawal, as shifting growing seasons, as unreliable ski conditions.',
...
export const designOpportunities: DesignOpportunity[] = [
  ...
  },
  {
    ...
    body: [
      'Nobody questions whether a toll road needs a traffic guarantee to be bankable. That is how you finance infrastructure before revenue history exists. We treat nature-based infrastructure as though it should attract capital on faith. Family offices cannot verify what they are buying. Projects are rarely where the family office is based. Measurement is hard. Permanence is uncertain. A bad bet does not just lose money. It makes you look foolish in front of your peers.',
    ],
    proposals: [
